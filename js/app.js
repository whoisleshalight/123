(() => {
        ...
        if (document.querySelector(".icon-menu")) document.addEventListener("click", (function(e) {
            if (bodyLockStatus && e.target.closest(".icon-menu")) {
                if (document.documentElement.classList.contains("menu-open")) {
                    ...
                    if (document.documentElement.classList.contains("projects-mobile-menu-open")) {
                        mobileMenu.querySelector(".mobile-menu__project-btn");
                        document.documentElement.classList.remove("projects-mobile-menu-open");
                    }
                }
                bodyLockToggle();
        ...
        eventsPopup() {
            document.addEventListener("click", function(e) {
                ...
                if (buttonClose || !e.target.closest(`.${this.options.classes.popupContent}`) && this.isOpen) {
                    if (document.querySelector(".pass--section")) {
                        const requestItemBox = document.querySelector(".pass--section");
                        requestItemBox.classList.remove("_hidden");
                        const entranceElement = document.querySelector(".entrance");
                        const requestElement = document.querySelector(".request");
                        if (entranceElement.classList.contains("_close")) entranceElement.classList.remove("_close");
                        if (requestElement.classList.contains("_open")) requestElement.classList.remove("_open");
                    }
                    e.preventDefault();
                    this.close();
                    return;
    ...
    function formSubmit() {
        ...
        function formSent(form, responseResult = ``) {
            ...
            setTimeout((() => {
                ...
                if (document.querySelector(".pass--section")) {
                    const requestItemBox = document.querySelector(".pass--section");
                    requestItemBox.classList.add("_hidden");
                }
            }), 0);
            formValidate.formClean(form);
    ...
    function initSliders() {
        if (document.querySelector(".project__slider")) new Swiper(".project__slider", {
...
*/    var getOwnPropertySymbols = Object.getOwnPropertySymbols;
    ...
    document.addEventListener("DOMContentLoaded", (event => {
        ...
        let scroll;
        setTimeout((() => {
            if (document.querySelector("[data-scroll-container]")) scroll = new locomotive_scroll_esm({
                el: document.querySelector("[data-scroll-container]"),
                smooth: true
            });
            const scrollBlocks = document.querySelectorAll(".scrollable-block");
            ...
            header.querySelectorAll("[data-scroll-to]").forEach((link => {
                link.addEventListener("click", (e => {
                    ...
                    if (targetEl) scroll.scrollTo(targetEl, {
                        duration: 400
                    });
                }));
            }));
            document.querySelectorAll(".spollers__title").forEach((title => {
            ...
            const textareas = document.querySelectorAll(".textarea-inp");
            ...
            const projectsBtn = document.querySelectorAll("._project-btn");
            if (projectsBtn) if (window.innerWidth >= 767.98) {
                let toCoursoreEl = document.querySelector(".cursor");
                projectsBtn.forEach((element => {
                    element.addEventListener("click", (function(e) {
                        e.preventDefault();
                        const scrollTop = scroll.scroll.instance.scroll.y;
                        if (scrollTop === 0) if (!document.documentElement.classList.contains("menu-projects")) {
                            document.documentElement.classList.add("menu-projects");
                            if (document.querySelector(".page--project")) {
                                document.querySelector(".page").style.opacity = "0";
                                document.querySelector("footer").style.opacity = "0";
                            }
                            if (toCoursoreEl) {
                                document.querySelector(".cursor__ball--big svg").style.transform = "scale(0)";
                                document.querySelector(".cursor__ball--small svg").style.transform = "scale(0)";
                            }
                        } else {
                            document.documentElement.classList.remove("menu-projects");
                            if (document.querySelector(".page--project")) {
                                document.querySelector(".page").style.opacity = "1";
                                document.querySelector("footer").style.opacity = "1";
                            }
                            if (toCoursoreEl) {
                                document.querySelector(".cursor__ball--big svg").style.transform = "scale(1)";
                                document.querySelector(".cursor__ball--small svg").style.transform = "scale(1)";
                            }
                        } else if (scrollTop > 60) if (!document.documentElement.classList.contains("menu-projects")) {
                            document.documentElement.classList.add("menu-projects");
                            document.querySelector(".page").style.opacity = "0";
                            document.querySelector("footer").style.opacity = "0";
                            if (toCoursoreEl) {
                ...
                scroll.on("scroll", (event => {
                    ...
                    if (document.documentElement.classList.contains("menu-projects") && scrollTop > 3) {
                        document.querySelector(".page").style.opacity = "1";
                        document.querySelector("footer").style.opacity = "1";
                        document.documentElement.classList.remove("menu-projects");
                        document.querySelector(".page").style.opacity = "1";
            ...
            } else projectsBtn.forEach((element => {
                element.addEventListener("click", (function(e) {
                    e.preventDefault();
                    document.documentElement.classList.toggle("lock");
                    document.documentElement.classList.toggle("menu-open");
                    document.documentElement.classList.toggle("projects-mobile-menu-open");
                }));
            }));
            scroll.on("scroll", (obj => {
                const header = document.querySelector(".header");
                if (obj.scroll.y > 60) header.classList.add("_header-scroll"); else header.classList.remove("_header-scroll");
            }));
            const spollerBtn = document.querySelectorAll(".spollers__item");
            if (spollerBtn) spollerBtn.forEach((element => {
                element.addEventListener("click", (function(e) {
                    setTimeout((() => {}), 1e3);
                }));
            }));
        ...
        if (isMobile.any()) {
            ...
            const subMenuItems = document.querySelectorAll(".projects-menu__item");
            subMenuItems.forEach((element => {
                const subMenuItemBtn = element.querySelector(".projects-menu__button");
                if (subMenuItemBtn) subMenuItemBtn.addEventListener("click", (function(e) {
                    const isActive = element.classList.contains("_active");
                    subMenuItems.forEach((item => item.classList.remove("_active")));
                    if (!isActive) element.classList.add("_active");
                }));
            }));
            document.addEventListener("click", (function(e) {
                const isClickInside = e.target.closest(".projects-menu__item");
                if (!isClickInside) subMenuItems.forEach((item => item.classList.remove("_active")));
            }));
        }
        const toCoursoreEl = document.querySelector(".cursor");
        if (window.innerWidth > 991.98 && !isMobile.any() || !isMobile.any()) {
            const $bigBallWrapper = document.querySelector(".cursor__ball--big");
            const $bigBall = $bigBallWrapper.querySelector(".cursor__ball");
            const $smallBall = document.querySelector(".cursor__ball--small");
            const $hoverables = document.querySelectorAll("a, button, input, .spollers__title");
            let mouseX = 0, mouseY = 0;
            let bigBallX = 0, bigBallY = 0;
            let smallBallX = 0, smallBallY = 0;
            let bigBallScale = 1;
            ...
            function animate() {
                ...
                bigBallX += (mouseX - bigBallX - 15) * .15;
                bigBallY += (mouseY - bigBallY - 15) * .15;
                smallBallX += (mouseX - smallBallX - 5) * .3;
                smallBallY += (mouseY - smallBallY - 10) * .3;
                $bigBallWrapper.style.transform = `translate3d(${bigBallX}px, ${bigBallY}px, 0)`;
                $smallBall.style.transform = `translate3d(${smallBallX}px, ${smallBallY}px, 0)`;
                $bigBall.style.transform = `scale(${bigBallScale})`;
            }
            animate();
        ...
        } else toCoursoreEl.remove();
        document.querySelectorAll(".item-contacts-form input, .item-contacts-form textarea").forEach((el => {
            el.addEventListener("focus", (() => {
                el.closest(".item-contacts-form").classList.add("_focus-item");
            }));
            el.addEventListener("blur", (() => {
                const parentForm = el.closest(".item-contacts-form");
                if (el.value.trim() !== "") parentForm.classList.add("_focus-item"); else parentForm.classList.remove("_focus-item");
            }));
            if (el.value.trim() !== "") el.closest(".item-contacts-form").classList.add("_focus-item");
        }));
        //!! Popup functional
                const entranceElement = document.querySelector(".entrance");
        const requestElement = document.querySelector(".request");
        if (entranceElement && requestElement) {
            const requestPassBtn = entranceElement.querySelector(".request-pass-btn");
            requestPassBtn.addEventListener("click", (function(e) {
                entranceElement.classList.add("_close");
                requestElement.classList.add("_open");
            }));
            const requestCloseBtnTwo = requestElement.querySelector(".pass-close-btn");
            const requestCloseBtn = requestElement.querySelector(".request-close-btn");
            closePassRequestWindow(requestCloseBtnTwo);
            closePassRequestWindow(requestCloseBtn);
            function closePassRequestWindow(element) {
                element.addEventListener("click", (function(e) {
                    entranceElement.classList.remove("_close");
                    requestElement.classList.remove("_open");
                }));
            }
        }
        const menuDesctopList = document.querySelector(".menu__list");
        if (window.innerWidth <= 767.98) menuDesctopList.remove();
        const menuDesctopProjects = document.querySelector(".projects-menu");
        if (window.innerWidth <= 767.98) menuDesctopProjects.remove();
        const mobileMenu = document.querySelector(".mobile-menu");
        if (mobileMenu) {
            const mobileMenuBtn = mobileMenu.querySelector(".mobile-menu__project-btn");
            mobileMenuBtn.addEventListener("click", (function(e) {
                document.documentElement.classList.toggle("projects-mobile-menu-open");
            }));
        }
        const headerRemoveMobProjectsMenuBtn = document.querySelector(".header-back-link");
        headerRemoveMobProjectsMenuBtn.addEventListener("click", (function(e) {
            if (document.documentElement.classList.contains("projects-mobile-menu-open")) document.documentElement.classList.remove("projects-mobile-menu-open");
        }));
        document.querySelectorAll("._project--link").forEach((link => {
            link.addEventListener("click", (function(e) {
                e.preventDefault();
                document.documentElement.classList.add("_transition");
                setTimeout((() => {
    ...
    document.addEventListener("click", (function(e) {
        if (e.target.closest("main")) if (document.querySelector(".menu-projects")) {
            document.querySelector(".page").style.opacity = "1";
            document.documentElement.classList.remove("menu-projects");
        }
    }));
